...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    // DEBUG: Log full response structure to understand GPT-Image-1 format
    console.log(`🔍 [${requestId}] GPT-Image-1 Full Response:`, JSON.stringify(dalleResponse, null, 2));
    console.log(`🔍 [${requestId}] Response data length:`, dalleResponse.data?.length || 0);
    console.log(`🔍 [${requestId}] First item structure:`, JSON.stringify(dalleResponse.data?.[0], null, 2));
    ...
    console.log(`🔍 [${requestId}] Extracted imageUrl:`, imageUrl);
