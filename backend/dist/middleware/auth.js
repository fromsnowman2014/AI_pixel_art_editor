...
const authPlugin = (fastify, options, done) => {
    ...
    fastify.decorate('authenticate', async (request, reply) => {
        ...
        const isAnonymousMode = env_1.env.NODE_ENV === 'development' || !authHeader;
        try {
            if (isAnonymousMode) {
                ...
                request.user = {
                    ...
                    rateLimits: {
                        ai: env_1.env.ANONYMOUS_AI_CALLS_PER_HOUR || 10, // Limited AI calls for anonymous users
            ...
            if (token === env_1.env.API_TEST_TOKEN || process.env.NODE_ENV === 'development') {
                ...
                request.user = {
                    ...
                    rateLimits: {
                        ai: env_1.env.AUTHENTICATED_AI_CALLS_PER_HOUR || 60, // Higher limits for authenticated users
     ...
     */
    fastify.decorate('authorize', (requiredPermission) => {
