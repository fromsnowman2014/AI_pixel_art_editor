...
export function TopToolbar({ className }: TopToolbarProps) {
  ...
  return (
    <div className={cn(
      'flex items-center justify-between bg-gradient-to-r from-white via-gray-50 to-white',
      'border-b border-gray-200/70 backdrop-blur-sm px-6 py-3 shadow-sm',
      className
    )}>
      ...
      <div className="flex items-center space-x-1">
        ...
        <div className="flex items-center rounded-lg bg-white/60 p-1 shadow-sm ring-1 ring-gray-200/50 ml-2">
